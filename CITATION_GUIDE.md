...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Bienestar Psicológico en Universitarios e Investigadores 2019-2024: Dashboard. GitHub. https://github.com/juanmoisesd/bienestar-psicologico-universitarios
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Bienestar Psicológico en Universitarios e Investigadores 2019-2024: Dashboard." GitHub. https://github.com/juanmoisesd/bienestar-psicologico-universitarios.
```

### BibTeX
```bibtex
@misc{delaserna2026_bienestarpsi,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Bienestar Psicológico en Universitarios e Investigadores 2019-2024: Dashboard},
  year         = {2026},
...
TI  - Bienestar Psicológico en Universitarios e Investigadores 2019-2024: Dashboard
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/bienestar-psicologico-universitarios
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Bienestar Psicológico en Universitarios e Investigadores 2019-2024: Dashboard. GitHub; 2026. Available: https://github.com/juanmoisesd/bienestar-psicologico-universitarios. ORCID: 0000-0002-8401-8018.
```

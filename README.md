# Psychological Wellbeing in University Students Dashboard
...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/bienestar-psicologico-universitarios/)
[![DOI](https://img.shields.io/badge/DOI-10.7910/DVN/EZP0YO-blue)](https://doi.org/10.7910/DVN/EZP0YO)


## Overview

Interactive dashboard: Psychological wellbeing in researchers and university students (2019-2024). DOI: 10.7910/DVN/EZP0YO

## 🌐 Live Dashboard

**[Open Interactive Dashboard](https://juanmoisesd.github.io/bienestar-psicologico-universitarios/)**

## Resources

| Resource | Link |
|---|---|
| Dataset DOI | [doi.org/10.7910/DVN/EZP0YO](https://doi.org/10.7910/DVN/EZP0YO) |
| Author | [juanmoisesdelaserna.es](https://juanmoisesdelaserna.es) |
| ORCID | [0000-0002-8401-8018](https://orcid.org/0000-0002-8401-8018) |

## How to Cite

> de la Serna Tuya, J.M. (2026). *Psychological Wellbeing in University Students Dashboard*. GitHub. https://github.com/juanmoisesd/bienestar-psicologico-universitarios
Also cite the dataset: https://doi.org/10.7910/DVN/EZP0YO
...
|---|---|
| Status | 🟢 Published |
| DOI | [10.7910/DVN/EZP0YO](https://doi.org/10.7910/DVN/EZP0YO) |
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Interactive dashboard: Psychological wellbeing in researchers and university students (2019-2024). DOI: 10.7910/DVN/EZP0YO* [Dataset]. GitHub. https://github.com/juanmoisesd/bienestar-psicologico-universitarios

**BibTeX**
```bibtex
@dataset{delaserna2025_bienestar_psicologico_universi,
  author    = {De la Serna Tuya, Juan Moisés},
  title     = {Interactive dashboard: Psychological wellbeing in researchers and university students (2019-2024). DOI: 10.7910/DVN/EZP0YO},
  year      = {2025},
  publisher = {GitHub},
  url       = {https://github.com/juanmoisesd/bienestar-psicologico-universitarios},
